...
function Footer() {
  ...
  return (
    <footer className="bg-brand-muted border-t border-brand-text/10 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Brand Section */}
          <div>
            <h3 className="text-xl font-extrabold text-brand-heading mb-3">BitByFerd</h3>
            <p className="text-brand-text text-sm">
              Where code meets clarity – a hub for projects, learning, and innovation.
            </p>
          </div>
          ...
          {/* Social Links */}
          <div>
            <h4 className="text-lg font-bold text-brand-heading mb-3">Connect</h4>
        ...
        {/* Copyright */}
        <div className="border-t border-brand-text/10 mt-8 pt-8 text-center">
          <p className="text-brand-text text-sm">
            &copy; {currentYear} BitByFerd. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
